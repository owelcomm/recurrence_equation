...
class RanDisplay(GridLayout):
    ...
    def gen_homogene(self):
        ...
        self.root.height+=270+160 #todo ajuster la hauteur
        self.nexthom = Button(text = "Afficher la solution",height=160,size_hint_y=None)
    ...
    def next_homog(self):
        ...
        i=Image(source="latex_tools/résolution.png",height=160,size_hint_y=None)
        i.reload()
        self.add_widget(i)
        ...
        self.root.height+=160+90+90+160+90+90+90+90 #todo ajuster la hauteur
    ...
    def gen_inhomog(self):
        ...
        self.add_widget(Label(text="Énoncé de l'exercice : ", halign="center", height=90, size_hint_y=None, color=labelcolor,
                              font_size='15sp'))
        self.add_widget(
            Label(text="Résoudre le système d'équation de récurrence suivant :", halign="center", height=90, size_hint_y=None,
                  color=labelcolor, font_size='15sp'))
        i = Image(source="latex_tools/équation_de_récurrence.png", height=90, size_hint_y=None)
        i.reload()
        self.add_widget(i)
        i = Image(source="latex_tools/contraintes.png", height=self.degree * 60, size_hint_y=None)
        ...
        self.root.height += 60 * self.degree
        self.add_widget(Widget(height=90))
        self.root.height += 90+90+90+90+160
        self.nextinhom = Button(text = "Afficher la solution",height=160,size_hint_y=None)
        self.nextinhom.on_press = self.next_inhom
        self.add_widget(self.nextinhom)

    def next_inhom(self):
        self.nextinhom.disabled=True
        self.add_widget(Label(text="Solution de l'exercice : ", halign="center", height=90, size_hint_y=None, color=labelcolor,
                              font_size='15sp'))
        text = "Les racines de l'équation caractéristique sont "
        for i in self.roots[0:-1]:
            text += str(i) + ", "
        ...
        text += " et " + str(self.roots[-1]) + ","
        self.add_widget(Label(text=text, halign="center", height=90, size_hint_y=None, color=labelcolor, font_size='15sp'))
        text = "et une solution particulière est :"
        self.add_widget(Label(text=text, halign="center", height=90, size_hint_y=None, color=labelcolor, font_size='15sp'))
        i = Image(source="latex_tools/solution_particulière.png", height=90, size_hint=(0.5, None))
        self.add_widget(i)
        i.reload()

        self.add_widget(Label(text="La solution générale est ", halign="center", height=90, size_hint_y=None, color=labelcolor,
                              font_size='15sp'))
        ...
        self.root.height += 90+90+90+90+90+90+90+120+160
