...
class SolutPartDisplay(GridLayout):
    def __init__(self,root,**kwargs):
        ...
        self.i = Image(source="latex_tools/solution_particulière.png", height=30, size_hint=(0.5,None))
        self.i.reload()
        self.add_widget(self.i)
        self.reload = Button(text = "recharger",height=30,size_hint_y=None,size_hint_x=0.3,halign="right")
        self.reload.on_press = self.generate_solut
        self.add_widget(self.reload)
        self.ok = Button(text = "ok",height=30,size_hint_y=None,size_hint_x=0.2,halign="right")
        self.ok.on_press = self.next
        self.add_widget(self.ok)
...
class InhomDisplay(GridLayout):
    ...
    def next_step(self):
        if self.state == "degree":
            self.add_widget(Label(text="Racines : ", halign="center",height=30,size_hint_y=None, color = labelcolor))
            ...
            i=Image(source="latex_tools/polynome_factorisé.png",height=30,size_hint_y=None)
            i.reload()
            self.add_widget(i)
            ...
            i.reload
            self.add_widget(i)
            self.add_widget(Label(text="Partie homogène de l'équation de récurrence :", halign="center",height=30,size_hint_y=None, color = labelcolor,font_size='20sp'))
            ...
            self.add_widget(Label(text="Solution particulière :", halign="center",height=30,size_hint_y=None, color = labelcolor,font_size='20sp'))
            i=Image(source="latex_tools/équation_de_récurrence_highlight.png",height=60,size_hint_y=None)
            i.reload()
